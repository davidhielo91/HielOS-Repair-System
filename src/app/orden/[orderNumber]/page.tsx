            ...
            {budgetSuccess ? (
              ...
              <>
                ...
                <p className="text-xs text-center text-gray-400 mt-3">
                  {cancellationFee > 0 ? (
                    <span>
                      Nota: Rechazar el presupuesto puede implicar un costo de diagnóstico de <b>{formatMoney(cancellationFee, currency)}</b>.
                    </span>
                  ) : (
                    "Si rechazas, podrás recoger tu equipo sin costo."
                  )}
                </p>
              </>
            )}
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowRejectModal(false)}>
            <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
              <div className="p-6 text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">¿Estás seguro de rechazar?</h3>
                <p className="text-sm text-gray-600 mb-6">
                  Al rechazar el presupuesto, se aplicará un costo de revisión/diagnóstico de:
                  <br />
                  <span className="text-xl font-bold text-gray-900 mt-2 block">{formatMoney(cancellationFee, currency)}</span>
                </p>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => handleBudgetAction("reject")}
                    className="flex-1 py-2.5 rounded-xl bg-red-600 font-semibold text-white hover:bg-red-700 transition-colors shadow-lg shadow-red-200"
                  >
                    Sí, Rechazar
                  </button>
                </div>
